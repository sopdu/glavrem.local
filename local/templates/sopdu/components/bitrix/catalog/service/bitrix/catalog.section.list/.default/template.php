...
<?foreach ($arResult['SECTIONS'] as &$arSection):?>
    ...
    <div class="col s12 m6 l4" id="<?=$this->GetEditAreaId($arSection['ID']);?>">
        <a href="<?=$arSection["SECTION_PAGE_URL"]?>" class="hover-block">
            <figure class="z-depth-1">
                <img src="<?=SITE_TEMPLATE_PATH?><?=$arSection["UF_ICON"]?>" alt="<?=$arSection["NAME"]?>"/>
                <figcaption><?=$arSection["NAME"]?></figcaption>
            </figure>
        </a>
    </div>
<?endforeach;?>
